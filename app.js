    ...
    const typeB = () => {
      ...
      const items = is2026Summary
        ? [
            {
              name: '개정 항목 1',
              desc: '사용자가 지정한 2026 개정 문구를 확인해 한 줄로 정리합니다.',
              tip: '확정 문서/링크가 없으면 단정하지 않습니다.'
            },
            {
              name: '개정 항목 2',
              desc: '동일하게 “무엇이 바뀌었는지 + 실전에서 무엇을 해야 하는지”로 정리합니다.',
              tip: '본룰 vs MLR(위원회 채택 필요)을 분리해서 말합니다.'
            },
            {
              name: '개정 항목 3',
              desc: '라운드에서 바로 헷갈리는 포인트 위주로 2줄 이내로 끝냅니다.',
              tip: '모르면 “확인 필요”라고 말하고 넘어갑니다.'
            },
            {
              name: '개정 항목 4',
              desc: '로컬룰/MLR은 코스/위원회 채택 시에만 적용될 수 있음을 고지합니다.',
              tip: '‘우리 코스는 채택했는지’ 확인이 먼저입니다.'
            },
            {
              name: '개정 항목 5',
              desc: '실전 팁은 측정 기준(클럽 길이/무릎 높이 등)으로 연결합니다.',
              tip: '측정 기준으로 분쟁을 줄입니다.'
            },
            {
              name: '개정 항목 6',
              desc: '마지막으로 “오늘 라운드에서 바로 적용할 행동”만 남깁니다.',
              tip: '정리 영상은 저장해두고 그대로 따라합니다.'
            },
          ]
        : [
            {
